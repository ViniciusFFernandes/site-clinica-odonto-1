// app.js — Clínica Odontológica Modelo
// Header inteligente no scroll, menu responsivo, reveal, scrollspy, slider antes/depois.
(function () {
  "use strict";
  ...
  var scrolledCls = ["bg-background/90", "backdrop-blur-xl", "shadow-[var(--shadow-soft)]", "py-3", "border-b", "border-border"];
      ...
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          sections.forEach(function (s) {
            s.link.classList.toggle("text-gold", s.sec === entry.target);
          });
        }
      });
